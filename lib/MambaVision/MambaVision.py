...
def build_MambaVision_T(num_classes:int):
    model = mamba_vision_T()
    incompatibleKeys = model.load_state_dict(torch.load('/mnt/workspace/ZJ/HiFuseV2/lib/MambaVision/mambavision_tiny_1k.pth.tar'), strict=False)
    print(incompatibleKeys)
    model.head = nn.Linear(model.head.in_features, num_classes)
    return model


def build_MambaVision_T_unpretrained(num_classes:int):
    model = mamba_vision_T()
    model.head = nn.Linear(model.head.in_features, num_classes)
    return model


def build_MambaVision_T2(num_classes:int):
    model = mamba_vision_T2()
    incompatibleKeys = model.load_state_dict(torch.load('/mnt/workspace/ZJ/HiFuseV2/lib/MambaVision/mambavision_tiny2_1k.pth.tar'), strict=False)
    print(incompatibleKeys)
    model.head = nn.Linear(model.head.in_features, num_classes)
    return model


def build_MambaVision_T2_unpretrained(num_classes:int):
    model = mamba_vision_T2()
    model.head = nn.Linear(model.head.in_features, num_classes)
    return model


def build_MambaVision_S(num_classes:int):
    model = mamba_vision_S()
    incompatibleKeys = model.load_state_dict(torch.load('/mnt/workspace/ZJ/HiFuseV2/lib/MambaVision/mambavision_small_1k.pth.tar'), strict=False)
    print(incompatibleKeys)
    model.head = nn.Linear(model.head.in_features, num_classes)
    return model

def build_MambaVision_S_unpretrained(num_classes:int):
    model = mamba_vision_S()
    model.head = nn.Linear(model.head.in_features, num_classes)
    return model


def build_MambaVision_B(num_classes:int):
    model = mamba_vision_B()
    incompatibleKeys = model.load_state_dict(torch.load('/mnt/workspace/ZJ/HiFuseV2/lib/MambaVision/mambavision_base_1k.pth.tar'), strict=False)
    print(incompatibleKeys)
    model.head = nn.Linear(model.head.in_features, num_classes)
    return model


def build_MambaVision_B_unpretrained(num_classes:int):
    model = mamba_vision_B()
    model.head = nn.Linear(model.head.in_features, num_classes)
    return model
...
def build_MambaVision_L(num_classes:int):
    model = mamba_vision_L()
    incompatibleKeys = model.load_state_dict(torch.load('/mnt/workspace/ZJ/HiFuseV2/lib/MambaVision/mambavision_large_1k.pth.tar'), strict=False)
    print(incompatibleKeys)
    model.head = nn.Linear(model.head.in_features, num_classes)
    return model


def build_MambaVision_L_unpretrained(num_classes:int):
    model = mamba_vision_L()
    model.head = nn.Linear(model.head.in_features, num_classes)
    return model


def build_MambaVision_L2(num_classes:int):
    model = mamba_vision_L2()
    incompatibleKeys = model.load_state_dict(torch.load('/mnt/workspace/ZJ/HiFuseV2/lib/MambaVision/mambavision_large2_1k.pth.tar'), strict=False)
    print(incompatibleKeys)
    model.head = nn.Linear(model.head.in_features, num_classes)
    return model