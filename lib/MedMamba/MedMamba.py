...
def build_MedMamba_T(num_classes:int):
    model = VSSM(depths=[2, 2, 4, 2],dims=[96,192,384,768],num_classes=num_classes)
    return model


def build_MedMamba_S(num_classes:int):
    model = VSSM(depths=[2, 2, 8, 2],dims=[96,192,384,768],num_classes=num_classes)
    return model


def build_MedMamba_B(num_classes:int):
    model = VSSM(depths=[2, 2, 12, 2],dims=[128,256,512,1024],num_classes=num_classes)
    return model


def build_MedMamba_S_nodrop(num_classes:int):
    model = VSSM(depths=[2, 2, 8, 2],dims=[96,192,384,768],num_classes=num_classes, drop_path_rate=0.)
    return model
